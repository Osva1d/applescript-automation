...
on getLegalForms()
    return {", a.s.", ", s.r.o.", ", spol. s r.o.", ", v.o.s.", ", k.s.", ", s.p.", ", z.s.", " a.s.", " s.r.o.", " spol. s r.o.", " v.o.s.", " k.s.", " s.p.", " z.s.", " a. s.", " s. r. o.", " spol. s r. o.", " v. o. s.", " k. s.", " s. p.", " z. s.", " Ltd.", " Inc.", " LLC", " GmbH", " AG", " SE", " SAS", " SARL", ",a.s.", ",s.r.o.", ",spol. s r.o.", ",v.o.s.", ",k.s.", ",s.p.", ",z.s.", ",a. s.", ",s. r. o.", ",spol. s r. o.", ",v. o. s.", ",k. s.", ",s. p.", ",z. s.", ", a.s", ", s.r.o", ", spol. s r.o", ", v.o.s", ", k.s", ", s.p", ", z.s", " a.s", " s.r.o", " spol. s r.o", " v.o.s", " k.s", " s.p", " z.s", " a. s", " s. r. o", " spol. s r. o", " v. o. s", " k. s", " s. p", " z. s", ",a.s", ",s.r.o", ",spol. s r.o", ",v.o.s", ",k.s", ",s.p", ",z.s", ",a. s", ",s. r. o", ",spol. s r. o", ",v. o. s", ",k. s", ",s. p", ",z. s"}
end getLegalForms
