...
tell application "Finder"
    try
        ...
        -- Jedin? záv?re?n? dialog s potvrzením a p?ipomenutím
        display dialog "Slo?ky projektu byly úsp??n? vytvo?eny!" & return & return & "Projekt: " & projectInfo & return & return & "Nezapome?te:" & return & "• Stisknout tla?ítko 'p?ijmout p?id?lení' v Safari" & return & "• Nakopírovat zdrojová data do slo?ky 'zdroje'" buttons {"OK"} default button "OK" with title "Hotovo!"
